...
{
    private const string CsvAssetPath = "Assets/Data/YUME_ROOF - Wardrobe.csv";
    private const string CatalogAssetPath = "Assets/Scripts/Wardrobe/WardrobeCatalog.asset";
